...
public interface HashTable<K, V> extends Iterable<HashTableEntry<K, V>> {
    ...
    /**
     * Put an entry (a pair key-value) in the table. If the key already exists,
     * overrides its associated value.
     *
     * @param key the key
    ...
    /**
     * Remove an entry (a pair key-value) from the table. Does nothing if the
     * key does not exist.
     *
     * @param key the key
